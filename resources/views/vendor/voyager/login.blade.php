...
<head>
    ...
    <title>Irene - Artificial intelligence assistant</title>
    ...
    <style>
        body {
            background-image:url('{{ asset(Voyager::image( Voyager::setting("admin.bg_image"), voyager_asset("images/bg.jpg") )) }}');
            ...
            <div class="clearfix">
                <div class="col-sm-12 col-md-10 col-md-offset-2">
                    <div class="logo-title-container">
                        ...
                        @else
                        <img class="img-responsive pull-left flip logo hidden-xs animated fadeIn" src="{{ asset(Voyager::image($admin_logo_img)) }}" alt="Logo Icon">
                        @endif
