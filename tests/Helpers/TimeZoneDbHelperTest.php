...
class TimeZoneDbHelperTest extends TestCase
{
     ...
     * @test
     */
    public function get_current_date_time_function_should_return_current_date_time_when_passed_dialogflow_agent_id()
    {
     ...
     * @test
     */
    public function get_current_date_time_function_should_return_current_date_time_when_passed_user_id()
    {
