...
class TaskerAutoRemoteService
{
    ...
    public function sendMessage(string $message) : string
    {
        ...
        $responseMessage = json_decode($response->getBody()->getContents(), true);

        Log::info('Tasker AutoRemote API send message request', ['Status' => $response->getStatusCode(), 'Request' => $requestUrl, 'Response' => $responseMessage]);
